...
<main>
  ...
  <ul>
    ...
    <ul>
      <li><a href="/test/recaptcha-v2-checkbox.php">"I'm not a robot" checkbox</a></li>
      <li><a href="/test/recaptcha-v2-checkbox-explicit.php">"I'm not a robot" checkbox - Explicit render</a></li>
      <li><a href="/test/recaptcha-v2-invisible.php">Invisible</a></li>
    </ul>
    </li>
    <li><h2>reCAPTCHA v3</h2>
    <ul>
      <li><a href="/test/recaptcha-v3-request-scores.php">Request scores</a></li>
    </ul>
    </li>
    <li><h2>General</h2>
    <ul>
      <li><a href="/test/recaptcha-content-security-policy.php">Content Security Policy</a></li>
    </ul>
    </li>
  </ul>
</main>
